...
public class EX2 : MonoBehaviour
{
    ...
    int moltiplicazionedeinumeri = 1;       // inizializzo la moltiplicazionedeinumeri a 1 perch� se uso 0 avrei sempre 0 come risultato della moltiplicazione indipendentemente dai valori nell'array
